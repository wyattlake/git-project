...
public class BlobTester {
    ...
    void testBlobCreated() throws Exception {
        ...
        assertTrue(Utils.exists(".gitproject/objects/d816fef546b01829364d78c90a6d49f3ea9eb356"));
    }
    ...
    void testBlobContents() throws Exception {
        ...
        String blobFileContent = Utils.unzipFile(".gitproject/objects/d816fef546b01829364d78c90a6d49f3ea9eb356");
